...
import { Account, Address, BIGINT_0, BIGINT_1, BIGINT_8, GWEI_TO_WEI, KECCAK256_RLP, bigIntToBytes, bigIntToHex, bytesToHex, concatBytes, equalsBytes, hexToBytes, intToBytes, setLengthLeft, short, unprefixedHexToBytes, } from '@ethereumjs/util';
...
export async function accumulateParentBlockHash(currentBlockNumber, parentHash) {
    ...
    const historyAddress = Address.fromString(bigIntToHex(this.common.param('vm', 'historyStorageAddress')));
